...
require (
	github.com/franciscovalentecastro/opentelemetry-operations-collector/internal/ottlfuncs v1.999.0
...
require (
	...
	github.com/franciscovalentecastro/opentelemetry-operations-collector/third_party/go-oniguruma v1.999.0 // indirect
